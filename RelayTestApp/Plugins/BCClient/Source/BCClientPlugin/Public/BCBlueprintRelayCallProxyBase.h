...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FBrainCloudRelayCallbackDelegate, uint8, netId, const TArray<uint8>&, data);
...
class UBCBlueprintRelayCallProxyBase : public UObject, public IRelayCallback
{
  ...
  public:
    ...
    //callbacks
    void relayCallback(uint8 netId,const TArray<uint8>& in_data)
    {
